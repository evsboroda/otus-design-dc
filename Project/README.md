...
1. На отдельной площадке собрать и настроить VXLAN/EVPN фабрику. 
2. Между коммутаторами DC-1 и DC-LZ для DCI миграции сервисов в новый ЦОД будет подлкючен дополнительный L2 линк.
2. В DC-1 постепенно будут отключаться SVI интерфейсы сервисов, что бы они начинали работать через DC-LZ.
